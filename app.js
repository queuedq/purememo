  ...
  var home = function (dictMonadAff) {
      return function (dictManageMemo) {
          var render = function (state) {
              return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Purememo") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ClearAll.create)) ])([ Halogen_HTML_Core.text("Clear all") ]), Purememo_Component_MemoList.memoList(state.memos), Purememo_Component_NewMemoForm.newMemoForm(CreateMemo.create) ]);
          };
          var initialState = {
          ...
          var $$eval = function (v) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Purememo_Capability_Resource_Memo.getMemos(Purememo_Capability_Resource_Memo.manageMemoHalogenM(dictManageMemo))(Purememo_Capability_Resource_Memo.All.value))(function (v2) {
                          var nextState = (function () {
                              ...
                              $16.memos = new Network_RemoteData.Success(v2);
                              return $16;
                          })();
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Purememo_Capability_Resource_Memo.createMemo(Purememo_Capability_Resource_Memo.manageMemoHalogenM(dictManageMemo))(memo))(function (v1) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Purememo_Capability_Resource_Memo.getMemos(Purememo_Capability_Resource_Memo.manageMemoHalogenM(dictManageMemo))(Purememo_Capability_Resource_Memo.All.value))(function (v2) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              ...
                              $21.memos = new Network_RemoteData.Success(v2);
                              return $21;
                          }))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                          });
              ...
              if (v instanceof ClearAll) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Purememo_Capability_Resource_Memo.getMemos(Purememo_Capability_Resource_Memo.manageMemoHalogenM(dictManageMemo))(Purememo_Capability_Resource_Memo.All.value))(function (v1) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Traversable.traverse(Data_Traversable.traversableArray)(Halogen_Query_HalogenM.applicativeHalogenM)(Purememo_Capability_Resource_Memo.deleteMemo(Purememo_Capability_Resource_Memo.manageMemoHalogenM(dictManageMemo)))(Data_Functor.map(Data_Functor.functorArray)(function (v2) {
                          return v2.id;
                      })(v1)))(function (v2) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                              var $26 = {};
                              ...
                              $26.memos = new Network_RemoteData.Success([  ]);
                              return $26;
                          }))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                          });
              ...
              throw new Error("Failed pattern match at Purememo.Component.Home (line 45, column 10 - line 70, column 13): " + [ v.constructor.name ]);
          };
